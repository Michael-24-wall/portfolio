...
export default function ProjectCard({ title, description, image, link, tech = [] }) {
  return (
    <div className="bg-gray-800 rounded-2xl overflow-hidden border border-gray-700 hover:border-yellow-400 transition-all duration-300 hover:transform hover:-translate-y-2">
      {/* Image Container */}
